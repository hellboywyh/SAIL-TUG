...
# LastEditTime : 2022-07-07 18:06:06
# FilePath     : \SAIL-TUG\vis_images.py
# Description  : Visualizing images and their keypoints
#-------------------------------------------# 
import json
import cv2
import os
...
with open("dataset/annotations/keyPoints.json","r") as f:
    ...
    for i in range(35646):
        ...
        im_res['result'] = [human]
        ori_img = cv2.imread("dataset/images/"+im_res['imgname'])
